...
//@Stateless // faz sentido termos 20 instancias da classe Banco? Não!!

@Singleton // agora sim, vamos dizer ao EJB que queremos apenas uma instancia ativa!
@Startup  // vamos informar o EJB que queremos que banco seja inicializado logo no startup da aplicacao!
public class Banco {
	...
	@PostConstruct
	void aposCriacao() {
		System.out.println("Nova intancia de banco criada!!");
	}
