...
public class LivrariaWSServiceLocator extends org.apache.axis.client.Service implements br.com.dextra.livraria.webservice.LivrariaWSService {
    ...
    public br.com.dextra.livraria.webservice.LivrariaWS getLivrariaWSPort() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.dextra.livraria.webservice.LivrariaWS getLivrariaWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.dextra.livraria.webservice.LivrariaWSServiceSoapBindingStub _stub = new br.com.dextra.livraria.webservice.LivrariaWSServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.dextra.livraria.webservice.LivrariaWS.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.dextra.livraria.webservice.LivrariaWSServiceSoapBindingStub _stub = new br.com.dextra.livraria.webservice.LivrariaWSServiceSoapBindingStub(new java.net.URL(LivrariaWSPort_address), this);
                _stub.setPortName(getLivrariaWSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.livraria.dextra.com.br/", "LivrariaWSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.livraria.dextra.com.br/", "LivrariaWSPort"));
        }
