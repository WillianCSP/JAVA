...
public class Categoria {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((restricaoIdade == null) ? 0 : restricaoIdade.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (nome == null) {
			...
			return false;
		if (restricaoIdade == null) {
			if (other.restricaoIdade != null)
				return false;
		} else if (!restricaoIdade.equals(other.restricaoIdade))
			return false;
		return true;
	}
	...
	public String toString() {
		return "Categoria [id=" + id + ", nome=" + nome + ", restricaoIdade="
				+ restricaoIdade + "]";
	}
}
